 ...
 * ```
 */
export function parse<T extends TreeAdapter = typeof import('parse5/lib/tree-adapters/default')>(
    html: string,
 ...
 * ```
 */
export function parseFragment<T extends TreeAdapter = typeof import('parse5/lib/tree-adapters/default')>(
    html: string,
    options?: ParserOptions<T>,
 ...
 * ```
 */
export function serialize<T extends TreeAdapter = typeof import('parse5/lib/tree-adapters/default')>(
